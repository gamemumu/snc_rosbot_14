...
def generate_launch_description():
    snc_rosbot_14_dir = get_package_share_directory('snc_rosbot_14')
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(snc_rosbot_14_dir, 'config', 'explore.yaml'),
    ...
    nav2_bringup_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(snc_rosbot_14_dir, 'launch', 'nav.launch.py')),
        launch_arguments={
